...
public class Main {
	...
	private static void addNewTravel(Scanner in, ArrayList<Travel> allTravels, ArrayList<IntermediateStation> intermadiateStations) {
	...
	//	IntermediateStation newIntermediateStation;
		...
		//input intermediate station
				...
				if(flag == 0) {
					...
					int intermediateHours = Integer.parseInt(intermediateLeavingTime[0]); //Converting String into integer using Integer.parseInt() 
			...
			//	newIntermediateStation = new IntermediateStation(intermediateStation, intermediateHours, intermediateMinutes);
					
			//		intermadiateStations.add(newIntermediateStation);   //why i cant add newIntermediateStation
